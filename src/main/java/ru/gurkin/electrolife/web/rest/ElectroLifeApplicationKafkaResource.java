...
@RestController
@RequestMapping("/api/electro-life-application-kafka")
public class ElectroLifeApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ElectroLifeApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ElectroLifeApplicationKafkaResource(KafkaProperties kafkaProperties) {
