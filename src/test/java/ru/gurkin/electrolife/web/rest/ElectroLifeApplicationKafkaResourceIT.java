...
import ru.gurkin.electrolife.config.KafkaProperties;

class ElectroLifeApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        ElectroLifeApplicationKafkaResource kafkaResource = new ElectroLifeApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/electro-life-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/electro-life-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
